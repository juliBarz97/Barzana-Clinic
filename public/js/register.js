window.onload = function () {
  ...
  function funcion_comprobacion() {
    ...
    if (input_password.value != input_cpassword.value) {
      ...
      findTotalCount(input_cpassword.value) < 3 ||
      findTotalCount(input_password.value) < 3
    ) {
      document.querySelector("#emailHelp").innerHTML =
        "Your password must have 3 numbers.";
      document.querySelector("#emailHelp").style.color = "red";
      document.querySelector("#emailHelp").style.fontSize = "large";
      document.querySelector("#password").style.borderColor = "red";
      document.querySelector("#cPassword").style.borderColor = "red";
      ...
      input_cpassword.value.length < 8 ||
      input_password.value.length < 8
    ) {
      document.querySelector("#emailHelp").innerHTML =
        "Your password must have 8 characters minimun.";
      document.querySelector("#emailHelp").style.color = "red";
      document.querySelector("#emailHelp").style.fontSize = "large";
      document.querySelector("#password").style.borderColor = "red";
      document.querySelector("#cPassword").style.borderColor = "red";
