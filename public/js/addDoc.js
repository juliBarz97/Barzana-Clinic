...
function addDoc_func() {
  ...
  count --
    ...
    document.querySelector('.text-error').innerHTML = "You must select at least 1 day for the doctor."
    document.querySelector('.text-error').style.color = "#850000"
    document.querySelector('.text-error').style.fontSize = "large"
    document.querySelector('#daysAvailable').style.backgroundColor = "#ffe6e0"
